    ...
    (variables) => ({
      abis: [
        ...
        },
        {
          ...
          file: '../../node_modules/@enzymefinance/protocol/artifacts/ChaiPriceFeed.json',
        },
        {
        ...
        },
        {
          ...
          file: '../../subgraphs/enzyme-core/utils/abis/CurveRegistry.json',
        },
      ],
      sources: () => {
        const dispatcher = {
        ...
        const releases = variables.releases.map((release, index) => [
          {
        ...
        return [dispatcher, ...releases[0], ...releases[1]];
      },
      templates: [
        {
          name: 'VaultLib',
