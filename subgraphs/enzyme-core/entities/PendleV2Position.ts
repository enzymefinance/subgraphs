...
import { ExternalPositionType, PendleV2Market, PendleV2Position, PendleV2PositionChange, PendleV2PrincipleTokenWithMarketAndDuration, Vault } from '../generated/schema';
...
function getPendleV2PrincipleTokenWithMarketAndDurationId(externalPosition: Address, principleToken: Address, market: Address): string {
    return externalPosition.toHex() + "/" + principleToken.toHex() + "/" + market.toHex();
}

export function ensurePendleV2PrincipleTokenWithMarketAndDuration(externalPosition: Address, principleToken: Address, market: Address): PendleV2PrincipleTokenWithMarketAndDuration {
