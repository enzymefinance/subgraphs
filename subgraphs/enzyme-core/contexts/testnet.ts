...
export const testnet: Context<Variables> = {
  ...
  variables: {
    ...
    persistent: {
      ...
      manualValueOracleFactoryAddress: '0x0b7fa18e37e9bd2e156cac8467d164261f5119cc',
    ...
    releases: {
      ...
      v4: {
        ...
        disallowedAdapterIncomingAssetsPolicyAddress: '0xb496d3453a07801248d7b4339e09546ac13eb141',
        ...
        noDepegOnRedeemSharesForSpecificAssetsPolicyAddress: '0x91cf2e3a615428f1f14fa3240b8dd52a2bdae649',
