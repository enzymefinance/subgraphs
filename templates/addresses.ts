...
export let releaseAddressesC: ReleaseAddresses = {
  fundDeployerAddress: Address.fromString('{{releases.2.fundDeployer}}'),
  vaultLibAddress: Address.fromString('{{releases.2.vaultLib}}'),
  comptrollerLibAddress: Address.fromString('{{releases.2.comptrollerLib}}'),
  valueInterpreterAddress: Address.fromString('{{releases.2.valueInterpreter}}'),
  integrationManagerAddress: Address.fromString('{{releases.2.integrationManager}}'),
  policyManagerAddress: Address.fromString('{{releases.2.policyManager}}'),
  feeManagerAddress: Address.fromString('{{releases.2.feeManager}}'),

  // Prices
  aggregatedDerivativePriceFeedAddress: Address.fromString('{{releases.2.aggregatedDerivativePriceFeed}}'),
  chainlinkPriceFeedAddress: Address.fromString('{{releases.2.chainlinkPriceFeed}}'),

  // Derivative Price Feeds
  aavePriceFeedAddress: Address.fromString('{{releases.2.aavePriceFeed}}'),
  alphaHomoraV1PriceFeedAddress: Address.fromString('{{releases.2.alphaHomoraV1PriceFeed}}'),
  chaiPriceFeedAddress: Address.fromString('{{releases.2.chaiPriceFeed}}'),
  compoundPriceFeedAddress: Address.fromString('{{releases.2.compoundPriceFeed}}'),
  curvePriceFeedAddress: Address.fromString('{{releases.2.curvePriceFeed}}'),
  idlePriceFeedAddress: Address.fromString('{{releases.2.idlePriceFeed}}'),
  lidoStethPriceFeedAddress: Address.fromString('{{releases.2.lidoStethPriceFeed}}'),
  stakehoundEthPriceFeedAddress: Address.fromString('{{releases.2.stakehoundEthPriceFeed}}'),
  synthetixPriceFeedAddress: Address.fromString('{{releases.2.synthetixPriceFeed}}'),
  uniswapV2PoolPriceFeedAddress: Address.fromString('{{releases.2.uniswapV2PoolPriceFeed}}'),
  wdgldPriceFeedAddress: Address.fromString('{{releases.2.wdgldPriceFeed}}'),
  yearnVaultV2PriceFeedAddress: Address.fromString('{{releases.2.yearnVaultV2PriceFeed}}'),

  // Peripheral
  fundActionsWrapperAddress: Address.fromString('{{releases.2.fundActionsWrapper}}'),

  // Fees
  managementFeeAddress: Address.fromString('{{releases.2.managementFee}}'),
  performanceFeeAddress: Address.fromString('{{releases.2.performanceFee}}'),
  entranceRateBurnFeeAddress: Address.fromString('{{releases.2.entranceRateBurnFee}}'),
  entranceRateDirectFeeAddress: Address.fromString('{{releases.2.entranceRateDirectFee}}'),

  // Policies
  adapterBlacklistAddress: Address.fromString('{{releases.2.adapterBlacklist}}'),
  adapterWhitelistAddress: Address.fromString('{{releases.2.adapterWhitelist}}'),
  assetBlacklistAddress: Address.fromString('{{releases.2.assetBlacklist}}'),
  assetWhitelistAddress: Address.fromString('{{releases.2.assetWhitelist}}'),
  investorWhitelistAddress: Address.fromString('{{releases.2.investorWhitelist}}'),
  guaranteedRedemptionAddress: Address.fromString('{{releases.2.guaranteedRedemption}}'),
  maxConcentrationAddress: Address.fromString('{{releases.2.maxConcentration}}'),
  minMaxInvestmentAddress: Address.fromString('{{releases.2.minMaxInvestment}}'),
  buySharesCallerWhitelistAddress: Address.fromString('{{releases.2.buySharesCallerWhitelist}}'),

  // Adapters
  aaveAdapterAddress: Address.fromString('{{releases.2.aaveAdapter}}'),
  alphaHomoraV1AdapterAddress: Address.fromString('{{releases.2.alphaHomoraV1Adapter}}'),
  chaiAdapterAddress: Address.fromString('{{releases.2.chaiAdapter}}'),
  compoundAdapterAddress: Address.fromString('{{releases.2.compoundAdapter}}'),
  curveExchangeAdapterAddress: Address.fromString('{{releases.2.curveExchangeAdapter}}'),
  curveLiquidityAaveAdapterAddress: Address.fromString('{{releases.2.curveLiquidityAaveAdapter}}'),
  curveLiquidityEursAdapterAddress: Address.fromString('{{releases.2.curveLiquidityEursAdapter}}'),
  curveLiquiditySethAdapterAddress: Address.fromString('{{releases.2.curveLiquiditySethAdapter}}'),
  curveLiquidityStethAdapterAddress: Address.fromString('{{releases.2.curveLiquidityStethAdapter}}'),
  idleAdapterAddress: Address.fromString('{{releases.2.idleAdapter}}'),
  kyberAdapterAddress: Address.fromString('{{releases.2.kyberAdapter}}'),
  paraSwapAdapterAddress: Address.fromString('{{releases.2.paraSwapAdapter}}'),
  paraSwapV4AdapterAddress: Address.fromString('{{releases.2.paraSwapV4Adapter}}'),
  synthetixAdapterAddress: Address.fromString('{{releases.2.synthetixAdapter}}'),
  trackedAssetsAdapterAddress: Address.fromString('{{releases.2.trackedAssetsAdapter}}'),
  uniswapV2AdapterAddress: Address.fromString('{{releases.2.uniswapV2Adapter}}'),
  yearnVaultV2AdapterAddress: Address.fromString('{{releases.2.yearnVaultV2Adapter}}'),
  zeroExV2AdapterAddress: Address.fromString('{{releases.2.zeroExV2Adapter}}'),
};
