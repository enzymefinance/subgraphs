...
import { RegistryContract } from '../generated/v1/VersionContract/RegistryContract';
import { VersionContract } from '../generated/v1/VersionContract/VersionContract';
...
function createRegistryDataSource(versionAddress: Address, registryAddress: Address): void {
  ...
  DataSourceTemplate.createWithContext('v1/RegistryContract', [registryAddress.toHex()], registryContext);
}
